defmodule Tornium.NotificationInator.ListAssertions do
  @moduledoc """
  ...
  defmacro assert_unordered(patterns, expressions) when is_list(patterns) do
    ...
    quote do
      Tornium.NotificationInator.ListAssertions.__assert_unordered__(
  ...
  def __assert_unordered__(patterns, {[], enum}, fun) do
    ...
    Tornium.NotificationInator.ListAssertions.__assert_unordered__(patterns, enum, fun)
  end
